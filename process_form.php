...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $senderEmail = $_POST['email address']; // Change variable name to avoid conflict
    $subject = $_POST['subject'];
    $messageContent = $_POST['tell us about the project']; // Rename to avoid conflict with Swift_Message object
    ...
    $swiftMessage->setTo(['emmanueljeremiah008@gmail.com' => 'IBUA ']);
