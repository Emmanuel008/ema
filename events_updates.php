...
if (isset($_POST['upload']) || isset($_POST['update'])) {
    ...
    if (isset($_POST['update'])) {
        ...
        $stmt = $conn->prepare("UPDATE events SET photo = ?, title = ?, description = ?, link = ? WHERE id = ?");
        if ($stmt === false) {
        ...
        $stmt = $conn->prepare("INSERT INTO events (photo, title, description, link) VALUES (?, ?, ?, ?)");
        if ($stmt === false) {
            die("Prepare failed: " . $conn->error);
        }
...
<head>
    <meta charset="UTF-8">
    <title>Event Records Management</title>
    ...
    <div class="row">
        <div class="col-md-5">
            <div class="form-container">
                <img alt="Logo" src="images/calendar.png" style="max-width: 100px; margin-bottom: 20px;">
        ...
        <div class="col-md-7">
            <br><br>
            <h2><strong>EVENTS RECORDS 🗓️</strong></h2>
